                    ...
                    {list.map((opt, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {opt.percentChange != null
                              ? `${opt.percentChange > 0 ? '+' : ''}${formatNum(opt.percentChange)}%`
                              : '-'}
                          </td>
                          <td className="py-2 px-3 text-right text-gray-900 dark:text-gray-300">
                            {opt.volume != null
                              ? formatNum(opt.volume, 0, 0)
                              : '-'}
                          </td>
                          <td className="py-2 px-3 text-right text-gray-900 dark:text-gray-300">
                            {opt.openInterest != null
                              ? formatNum(opt.openInterest, 0, 0)
                              : '-'}
                          </td>
